...
var _=require('@stdlib/blas-base-assert-is-layout/dist'),C=require('@stdlib/ndarray-base-assert-is-row-major-string/dist'),O=require('@stdlib/ndarray-base-assert-is-column-major-string/dist'),T=require('@stdlib/math-base-special-fast-max/dist'),j=require('@stdlib/error-tools-fmtprodmsg/dist'),z=p();function B(r,a,t,n,e){var s,v,i;if(!_(r))throw new TypeError(j('nullFx',r));if(C(r)?i=t:i=a,e<T(1,i))throw new RangeError(j("invalid argument. Fifth argument must be greater than or equal to max(1,%d). Value: `%d`.",i,e));return O(r)?(s=1,v=e):(s=e,v=1),z(a,t,n,s,v,0)}w.exports=B
